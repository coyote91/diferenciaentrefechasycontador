...
echo date("Y-m-d H:i:s",strtotime("1 day ago"));
echo "<br>";
...
$query = $conexion->query($consulta);
   ...
   echo "fecha compra es :" . $date =$arraylogin->fecha;
 
       //echo time_elapsed_string('2013-05-01 00:22:35');
   echo "<br> El tiempo transcurrido cuando hiciste la compra es : " . getHowLongAgo($date);
